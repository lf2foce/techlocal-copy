...
async def generate_image_prompts(text: str, style: str = "realistic", num_prompts: int = 1) -> List[Tuple[str, str, str]]:
    ...
    2. **`english_prompt` (string)**: Prompt **tiếng Anh** chi tiết theo phong cách {style}, bao gồm:
       - Chủ thể chính và hành động (ưu tiên mô tả người Việt, không sử dụng từ nhạy cảm như young/girl/boy/child, có thể dùng các từ thay thế: person, individual, professional, character Man, Woman)
    ...
    Yêu cầu Output:
    - english_prompt phải tuân thủ phong cách {style} và giới hạn 55-70 từ
